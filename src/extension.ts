...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand("inwt-python-ide.smartExecAndStep", async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand("inwt-python-ide.debugExecAndStep", async () => {
            let editor = vscode.window.activeTextEditor;
            if (editor) {
                smartSelect();
                await delay();
...
function updateWorkspaceSettingsAccordingToINWTStandards() {
    if (getConfigUpdateSettings()) {
        ...
        setWorkspaceSetting(
            "githubIssues",
            "issueBranchTitle",
            "feature/${issueNumber}_${sanitizedIssueTitle}",
        );
